    ...
    public partial class wak : System.Web.UI.Page
    {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            foreach (GridViewRow gw in GridView1.Rows)
            {
                ...
                {
                    string Val16 = (gw.FindControl("Label1") as Label).Text;//
                    ...
                    string Val15 = (gw.FindControl("Label21") as Label).Text;//
                    string Val17 = (gw.FindControl("Label20") as Label).Text;//

                    dt.Rows.Add(Val16, Val1, Val2, Val3, Val4, Val5, Val6, Val7, Val8, Val9, Val11, Val12, Val13, Val14, Val15, Val17);
                }
            }
