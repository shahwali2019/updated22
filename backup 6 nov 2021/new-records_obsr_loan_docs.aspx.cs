        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["olds_id"] != null)
                {
                    ...
                    txtFacilityTypeList.SelectedValue = Session["fctp"].ToString();
                    ...
                    txtstasobsr.SelectedValue = Session["outsobsr"].ToString();
                    txtoutstnobr.Text = Session["statusobsr"].ToString();
