...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="height: 120px; padding-left: 45%; border-top: 10px solid #0094ff; margin-top: -20px;" class="alert alert-success" role="alert">
        <h4 class="alert-heading" style="font-family: Bahnschrift;"><strong>
            <asp:Label ID="addLbl" runat="server" Text="NEW MCU RECORD"></asp:Label></strong></h4>
    </div>
        ...
        <table class="auto-style17" style="padding-bottom: 5px;">
            ...
            <tr>
                ...
                <td class="auto-style33">
                    <strong>Due Date of MCU<span style="color: red;">*</span></strong></td>
                <td colspan="2">
            ...
            <tr>
                ...
                <td class="auto-style37">
                    ...
                    &nbsp;</td>
                <td class="auto-style33">M<strong>CU Date </strong></td>
                <td style="width: 209px" colspan="2">
                    <asp:TextBox ID="txtmcudate" CssClass="center" runat="server" Height="40px" Width="196px" Font-Bold="True" Font-Size="Smaller" TabIndex="7" Enabled="False" TextMode="Date"></asp:TextBox>
                </td>
                <td  class="auto-style6">
            ...
            <tr>
                ...
                <td class="auto-style18">
                    <asp:TextBox ID="txtDisburesment" CssClass="center" runat="server" Height="40px" Width="196px" Font-Bold="True" Font-Size="Smaller" TabIndex="5" OnTextChanged="txtClient_TextChanged" TextMode="Date"></asp:TextBox>
                </td>
                <td class="auto-style37">
                ...
                <td class="auto-style34" rowspan="4">
                    <strong>
                        <asp:Button ID="subBtn" runat="server" CssClass="btn-primary" Height="37px" Text="ADD" Width="81px" Font-Bold="True" Font-Size="Small" TabIndex="10" OnClick="subBtn_Click" BorderStyle="Solid" BackColor="White" BorderColor="#666666" ForeColor="Gray" />
                    </strong></td>
