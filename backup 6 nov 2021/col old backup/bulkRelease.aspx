...
&nbsp;
    ...
    <br />
     <asp:Panel runat="server" DefaultButton="Button2" Height="55px" Width="1218px"> 
            ...
            </strong>&nbsp;<asp:TextBox ID="bulkbname" placeholder="Customer name" runat="server" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Small" Width="150px" BackColor="White" Height="29px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>
            &nbsp;
        ...
        <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="Smaller" ForeColor="Black" Text="with Dino" Font-Names="Bahnschrift"></asp:Label>&nbsp;
            ...
            <asp:TextBox ID="bulkdino" placeholder="Dino" runat="server" Width="59px" Font-Names="Bahnschrift" BackColor="White" Height="29px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>
       
        &nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" CssClass="btn btn-success" Font-Names="Bahnschrift" Text="FIND" Width="62px" OnClick="Button2_Click" BorderStyle="None" Font-Size="XX-Small" Height="29px"  />
            ...
            <asp:TextBox ID="bulkPdate" runat="server" BackColor="White" Font-Names="Bahnschrift" Font-Size="Small" Height="29px" TextMode="Date" Width="130px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>
            ...
            <asp:TextBox ID="txtCartonVal" runat="server" AutoPostBack="true" placeholder=" .i.e 25" BackColor="White" Font-Names="Bahnschrift" Height="29px" OnTextChanged="txtCartonVal_TextChanged" Width="44px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>
            ...
            <asp:Button ID="Button5" runat="server" CssClass="btn btn-success" Font-Bold="True" Font-Size="XX-Small" Height="29px" OnClick="Button5_Click" Text="UPDATE" Width="63px" BorderStyle="None" />
            &nbsp;<asp:Button ID="btnJump" runat="server" CssClass="btn btn-success" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Small" Height="29px" Text="Queue Jump" Visible="False" Width="112px" OnClick="btnJump_Click" BorderStyle="None" />
            <br />
            <br />
            </strong>
                  </asp:Panel>
    ...
    &nbsp;&nbsp;<asp:Label ID="msg2" runat="server" Font-Bold="True" Font-Size="X-Small" ForeColor="#0099FF" Visible="False"></asp:Label>
        ...
        <asp:SqlDataSource ID="SqlCon" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>"
            ...
            <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand" runat="server"
               ...
               BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="id" DataSourceID="SqlCon" PageSize="7" GridLines="Horizontal" >
