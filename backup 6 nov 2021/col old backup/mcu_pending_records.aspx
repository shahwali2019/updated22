...
<div style="margin-top:10px" class="auto-style2">
    <asp:GridView ID="GridView2" OnRowCommand="GridView2_RowCommand"   runat="server" ShowHeaderWhenEmpty="True"
               ...
               BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="id" DataSourceID="SqlCon2" PageSize="7" Width="1172px" Visible="False" GridLines="None" BackImageUrl="~/image/logo.png" CaptionAlign="Top" EmptyDataText="N/A" EnableTheming="True" Font-Names="Bahnschrift" RowHeaderColumn="Customer Name" ToolTip="MCU Inserted Pending Records">
                        <AlternatingRowStyle BackColor="#CEEFFF" ForeColor="#333333" BorderStyle="None" HorizontalAlign="Center" VerticalAlign="Middle" />
               <Columns>
