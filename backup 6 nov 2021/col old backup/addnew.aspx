   ...
   <div style=" height:120px;padding-left: 45%;border-top:10px solid #0094ff; margin-top:-20px;" class="alert alert-success" role="alert">
    ...
    .auto-style43 {
        ...
        <tr>
            ...
            <td style="width: 209px">
                <asp:TextBox ID="txtDateRelease" runat="server" Height="40px" Width="196px" AutoPostBack="true" TabIndex="12" OnTextChanged="txtDateRelease_TextChanged"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td class="auto-style43">
                <asp:TextBox ID="TxtDateforRotation" runat="server" Height="40px" Width="196px" TabIndex="13"></asp:TextBox>
            </td>
        </tr>
        <tr>
