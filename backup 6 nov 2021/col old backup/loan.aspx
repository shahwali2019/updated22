...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div>
      ...
      <div style="margin-left:0px; margin-top:-20px;  " class="auto-style2">        
         ...
         <asp:ImageButton ID="ImageButton1" runat="server" Height="20px" ImageUrl="~/image/excel1.png" Width="24px" OnClick="ImageButton1_Click" ToolTip="Export to MS Excel 2016" TabIndex="5" />&nbsp;<asp:ImageButton ID="ImageButton3" runat="server" Height="20px" ImageUrl="~/image/update.jpg" Width="24px" ToolTip="Bulk update" OnClick="ImageButton3_Click" TabIndex="6" />
          <br />
          <br />
        </div>
        <br />
         ...
         <asp:Panel runat="server" DefaultButton="searchBtn">
             <table>
                 <tr style="padding:10px 10px;">
                     <td><asp:TextBox ID="searchbarTxt" placeholder="Customer Name" runat="server" Height="31px" Width="168px" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Small" TabIndex="2" CssClass="form-control"></asp:TextBox></td>
                    <td>&nbsp;</td>
                     <td><asp:TextBox ID="txtDino" runat="server" placeholder="Dino" Height="31px" Width="60px" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Small" TabIndex="3" CssClass="form-control"></asp:TextBox></td>
                    <td>&nbsp;</td>
                     <td><asp:TextBox ID="txtPdate" runat="server" Height="31px" placeholder="Dino" TextMode="Date" Width="155px" Font-Names="Bahnschrift" Font-Size="Small" TabIndex="4" CssClass="form-control"></asp:TextBox></td>
               <td>&nbsp;</td>
                     <td>
                          <asp:DropDownList ID="statusList" runat="server" CssClass="form-control" Height="31px" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Small" TabIndex="5">
            ...
            <asp:Button ID="searchBtn" runat="server" CssClass="btn-primary" Font-Bold="True" Font-Size="Small" Height="31px" OnClick="searchBtn_Click" Text="Search" Width="67px" Font-Names="Bahnschrift" BorderStyle="None" />
       ...
       <%-- <asp:CheckBox AutoPostBack="true" ID="Main" runat="server" Font-Bold="True" Font-Size="X-Small" ForeColor="Blue" OnCheckedChanged="Main_CheckedChanged" Text="Main Records" Visible="False" />
        ...
        <br />
        <asp:GridView ID="GridView2" OnRowCommand="GridView2_RowCommand" runat="server"
               AllowSorting="True" CssClass="center" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC"
               BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="id" DataSourceID="SqlCon2" PageSize="7" Visible="False"
        ...
        <asp:SqlDataSource ID="SqlCon" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" 
         ...
         <asp:SqlDataSource ID="SqlCon2" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" 
            ...
            SelectCommand="SELECT * FROM [Loanadder_tbl2]" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
            ...
            SelectCommand="select bname as Customer,count(id) as Amount,Telecom,pdate Date from loanadder_tbl 
