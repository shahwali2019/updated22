<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="newmtr.aspx.cs" Inherits="Collateral_int.newmtr" %>
<asp:Content ID="Content1" ContentplaceholderID="MainContent" runat="server">
    ...
    <div style="border-top: 10px solid #0094ff; margin-top: -10px; text-align:center" class="alert alert-success" role="alert">
        <h4 class="alert-heading" style="font-family: Bahnschrift;"><strong>
            <asp:Label ID="pageLable" runat="server" Text="ADD NEW MANUAL TRANSACTION RECORD"></asp:Label></strong></h4>
    </div>
            <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="form-group-sm">
                 ...
                 <div class="col-md-2">
                <div class="form-group-sm">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Font-Size="X-Small" ErrorMessage="X" ControlToValidate="txtMemoSub" ForeColor="Red"></asp:RequiredFieldValidator>
