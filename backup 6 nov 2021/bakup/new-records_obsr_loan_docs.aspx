    ...
    <div style="background-color: #fff; padding: 50px; margin-top: -40px;">
        ...
        <table class="auto-style17" style="padding-bottom: 5px;">
            ...
            <tr>
                ...
                <td style="width: 209px">
                    <asp:TextBox ID="txtiniobseerv" CssClass="center" runat="server" Height="40px" Width="196px" AutoPostBack="true" Font-Bold="True" Font-Size="Smaller" TabIndex="12" ></asp:TextBox>
            ...
            <tr>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtoutstnobr" ErrorMessage="X" Font-Names="Bahnschrift" Font-Size="XX-Small" ForeColor="Red"></asp:RequiredFieldValidator>
                                ...
                                <td style="width: 209px">
                    <asp:TextBox ID="txtoutstnobr" CssClass="center" runat="server" Height="40px" Width="196px" AutoPostBack="true" Font-Bold="True" Font-Size="Smaller" TabIndex="12" ></asp:TextBox>
