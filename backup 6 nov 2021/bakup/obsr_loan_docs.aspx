   ...
   <div style="margin-left:20px;">
        ...
        <Columns>
                    ...
                    <asp:TemplateField HeaderText="Document checking date" SortExpression="Document checking date">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label3" runat="server" Text='<%# Bind("[Document checking date]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="Borrower" SortExpression="Borrower">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label4" runat="server" Text='<%# Bind("[Borrower]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="Case Number" SortExpression="Case Number">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label5" runat="server" Text='<%# Bind("[Case Number]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="Facility amount" SortExpression="Facility amount">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label8" runat="server" Text='<%# Bind("[Facility amount]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="Customers type" SortExpression="Customers type">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label9" runat="server" Text='<%# Bind("[Customers type]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="initial observations" SortExpression="initial observations">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label10" runat="server" Text='<%# Bind("[initial observations]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="Outstanding observations" SortExpression="Outstanding observations">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label11" runat="server" Text='<%# Bind("[Outstanding observations]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="Status of Observation" SortExpression="Status of Observation">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label12" runat="server" Text='<%# Bind("[Status of Observation]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="Status of Facility" SortExpression="Status of Facility">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label13" runat="server" Text='<%# Bind("[Status of Facility]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="Inserted By" SortExpression="Inserted By">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label14" runat="server" Text='<%# Bind("[1st checker]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="Remarktttttttttts" SortExpression="Remarks">
                         <EditItemTemplate>
                             <asp:TextBox ID="TextBox14" runat="server" Text='<%# Bind("[Remarks]") %>'></asp:TextBox>
                         </EditItemTemplate>
                         <ItemTemplate>
                             <asp:Label ID="Label16" runat="server" Text='<%# Bind("[Remarks]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="Updated By" SortExpression="Updated By">
                         ...
                         <ItemTemplate>
                             <asp:Label ID="Label17" runat="server" Text='<%# Bind("[Updated By]") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle CssClass="center" />
                         <ItemStyle CssClass="center" />
                     </asp:TemplateField>
