...
<div style="margin-left:20px;">
   ...
   <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" OnDataBound="GridView1_DataBound" HeaderStyle-ForeColor="#636363" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="StringCon" GridLines="Horizontal" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" EnableTheming="True" HorizontalAlign="Center">
