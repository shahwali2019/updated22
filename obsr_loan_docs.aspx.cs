...
namespace Collateral
{
    public partial class obsr_loan_docs : System.Web.UI.Page
    {
        ...
        protected void excelExporter_Click(object sender, ImageClickEventArgs e)
        {
            ...
            dt.Columns.Add("id");
            dt.Columns.Add("<p style='font-size: 200px'>Document checking date</p>");
            ...
            foreach (GridViewRow gw in GridView1.Rows)
            {
                ...
                if (chkSelect.Checked)
                {
                    ...
                    dt.Rows.Add(Val1, Val2, Val3, Val17, Val4, Val5, Val6, Val7, Val8, Val9, Val10, Val11, Val12, Val13, Val14, Val15, Val16);
                }
            }
            //--------------------------------
            var products = dt;
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                if (rdr.Read())
                {
                    ...
                    Session["deprt"] = (string)rdr["Department"].ToString(); //  [Borrower]
